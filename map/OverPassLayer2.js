...
L.OverPassLayer = L.FeatureGroup.extend({
  ...
  _poiInfo: function(tags,id,latpoi,lonpoi,lat,lon,distanza) {
    var link = document.createElement("a");
      console.log(distanza);
    link.href = "https://www.openstreetmap.org/directions?engine=mapzen_foot&route="+lat+"%2C"+lon+"%3B"+latpoi+"%2C"+lonpoi+"#map=15/"+lat+"/"+lon;
    link.appendChild(document.createTextNode("Percorso pedonale fin qui"));
    ...
    //  row.insertCell(2).appendChild(document.createTextNode("Dista in mt: "+distanza));
    }
    var div = document.createElement("div");
    div.appendChild(link);
    div.appendChild(table);
    div.appendChild(document.createTextNode("Dista "+distanza+" mt"));
    return div;
  },
